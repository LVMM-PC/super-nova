<template>
  <div id="everything">
    ...
    <h2 id="overview">规范说明</h2>
    <section>
      <blockquote>
        <p>写在规则前面的话——项目的可维护性第一。</p>
        <small>阿当</small>
      </blockquote>
      <p>此规范为参考规范，不全是硬性要求，部分硬性约定见 <a href="#document">文档结构</a> &amp; <a href="#html">书写规范</a>,统一团队编码规范和风格。</p>
      <p>目标是让所有代码都是有规可循的，并且能够得到沉淀，减少重复劳动。</p>
      <div class="tips"><strong>大家一起完善。 </strong> 也可以参考引自：<a href="https://github.com/aralejs/aralejs.org/wiki">开发规范</a>来完善。
      </div>
    </section>

    <h2 id="document">文档结构</h2>
    <section>
...
&lt;/html&gt;
      ...
      <ul>
        ...
        <li><code>&lt;img&gt;</code> 标签默认缺省格式：<code>&lt;img src="xxx.png" alt="缺省时文字" /&gt;</code> 避免出现 <a
          href="http://js8.in/555.html" target="_blank" title="src=&quot;&quot; 问题"> src="" 问题</a></li>
        <li><code>&lt;a&gt;</code> 标签缺省格式：<code>&lt;a href="###" title="链接名称"&gt;xxx&lt;/&gt;</code> 注：<code>target="_blank"</code>
          根据需求决定
        </li>
        <li><a>标签预留链接占位符使用 <code>###</code>，参见：</a> <a target="_blank" href="http://www.v2ex.com/t/48511/"
                                                       title="a标签占位符问题">a标签占位符问题</a>
        </li>
        <li>所有标签需要符合XHTML标准闭合</li>
        <li>一律统一标签结尾斜杠的书写形式：<code>&lt;br /&gt;</code> <code>&lt;hr /&gt;</code> 注意之间空格</li>
        <li>避免使用已过时标签，如：<code>&lt;b&gt;</code> <code>&lt;u&gt;</code> <code>&lt;i&gt;</code>
          而用 <code>&lt;strong&gt;</code> <code>&lt;em&gt;</code> 等代替
        </li>
      ...
      <h4>HTML 细化规范</h4>
      <ul>
        <li>HTML <code>head</code> 部分的结构参看：<a target="_blank"
                                              href="https://github.com/webcoding/cool-head">cool-head</a> (摘取必要内容即可)
        </li>
        ...
        <li>HTML 代码尽量过一遍 <a target="_blank" href="http://html5.validator.nu/">HTML5 验证</a></li>
        <li>HTML 占位图片使用 <a target="_blank" href="http://temp.im/">temp.im</a> &amp; <a target="_blank"
                                                                                       href="http://placehold.us/">placehold.us</a>
          图片服务
        </li>
      </ul>
      ...
      <p>比如你的代码看起来应该像这样:</p>
      <pre><code>&lt;a class="" id="" data-modal="" href=""&gt;链接示例&lt;/a&gt;
</code></pre>
    </section>
...
.ticket-search { }
      ...
      <h4>错误示例：</h4>
      <pre><code>.selector, .selector-secondary, .selector[type=text] {
    padding:15px;
    margin:0px 0px 15px;
...
.modal-header {
  ...
      ...
      <p>Good example:</p>
      <pre><code>/* Wrapping element for .modal-title and .modal-close */
.modal-header {
  ...
}
</code></pre>
...
if (true) {
    ...
    allowed();
      ...
      <p>Bad example:</p>
      <pre><code>// 不好的写法：代码和注释间没有足够的空格
var result = something + somethingElse;// somethingElse will never be null;
</code></pre>
      <p>Good example:</p>
      <pre><code>var result = something + somethingElse; // somethingElse will never be null;
</code></pre>
...
try {
    ...
    <h2 id="json">JSON格式规范</h2>
    <section>
      <p>参考<a target="_blank" href="https://github.com/webcoding/google-styleguide/blob/master/JSONStyleGuide.md">JSON Style Guide翻译</a>，原版：<a
        target="_blank"
        href="http://google-styleguide.googlecode.com/svn/trunk/jsoncstyleguide.xml">Google JSON Style Guide</a></p>
    </section>

    <h2 id="readme">说明文档书写规范</h2>
    <section>
      //TODO
    </section>

    <h2 id="edm">EDM 制作规范</h2>
    <section>
      <ul>
      ...
      <p>更多细节参考下面链接：<br><a target="_blank"
                           href="http://www.web-ed.com.au/2011/05/coding-html-newsletters-edms-quick-guide/">12 Killer Tips and Tricks for Building HTML Email</a>
      </p>
    </section>
