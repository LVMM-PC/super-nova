  ...
  <div id="everything">
    ...
    <div>
      <ul>
        ...
        <li>
          <a href="http://pic.lvmama.com/js/lv/calendar.js" target="_blank">http://pic.lvmama.com/min/index.php?f=/js/lv/calendar.js</a>
        </li>
      </ul>
    </div>
...
<code class="js">
    ...
    <div class="section">
      ...
      <p>
        ...
        <span class="btn bigChange">201608</span>
      </p>
    </div>
    ...
    <div class="section" id="ajaxCalendarBox">
